...
public class AgendaDeConsulta {
    ...
    @Autowired
    List<ValidadorAgendamentoDeConsultas> validadoresAgendamento;
    ...
    public DadosDetalhamentoConsulta agendar(DadosAgendamentoConsulta dados) {
        ...
        if (medico == null) {
            throw new ValidacaoException("Não existe m médico disponível nessa data");
        }
    ...
    private Medico escolherMedico(DadosAgendamentoConsulta dados) {
        ...
        if (dados.especialidade() == null) {
            throw new ValidacaoException("Especialidade é obrigatõria quando o médico não for escolhido.");
        }
